...
$(document).on('click','.button',function(e){
    ...
    if(person_age == "" || person_income == "" ||person_home_ownership == ""||person_emp_length == ""||person_emp_length > person_age||loan_intent == ""||loan_grade == ""||
      ...
      $.ajax({
        url: 'https://will-they-default.herokuapp.com/predict',
